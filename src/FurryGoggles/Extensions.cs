...
namespace FurryGoggles
{
	public static class Extensions
	{
		...
		public static void TrySetClipboardText(this string text)
		{
			int attempt = 0;
			while (attempt++ < 10)
			{
		...
		public static T InvokeIfRequired<T>(this ISynchronizeInvoke control, Func<T> func)
		{
			return control.InvokeRequired ? (T)control.Invoke(func, null) : func();
		}
